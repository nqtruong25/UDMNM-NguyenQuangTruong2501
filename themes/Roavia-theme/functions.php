...
function roavia_enqueue_scripts() {
    ...
    wp_enqueue_script('bootstrap-js', 'https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/js/bootstrap.bundle.min.js', array(), null, true); // Không cần jquery cho Bootstrap 5
}
...
function roavia_theme_setup() {
    ...
    add_theme_support('widgets'); // Nếu có dùng widgets
    load_theme_textdomain('roavia_theme', get_template_directory() . '/languages'); // Hỗ trợ dịch theme
